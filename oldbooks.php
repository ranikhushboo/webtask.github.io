...
<input type="textarea" name="bookname" class="form-control" id="conpass" value="<?php echo $row['bookname']?>" autocomplete="off">
<span id="confirmpass" class="text-danger font-weight-bold"></span>
		...
		<div class="form-group">
        <label>Price</label>
        <input type="text" name="price" class="form-control" id="price" value="<?php echo $row['rentprice']?>">
