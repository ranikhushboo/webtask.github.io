...
require("conn.php");
		...
		if(isset($_REQUEST["submit"]))
        {
          ...
          $qry = "insert into onrent (username,email,mobileno,course,duration,bookname,rentprice) values ('$username','$email','$mobileno','$course','$duration','$bookname','$rentprice')" ;
...
<form method="post" action="confirmorder.php" onclick="return validation()" class="bg-light">
...
<span id="mobile no" class="text-danger font-weight-bold"></span>
	  ...
	  <div class="form-group">
                      ...
                      <select name="subject" id="selectdur" class="form-control required">
	                  <span class="req">
...
<input type="textarea" name="bookname" value="<?php echo $row['bookname']?>" class="form-control" id="conpass" >
<span id="confirmpass" class="text-danger font-weight-bold"></span>
		...
		<div class="form-group">
        <label>Price</label>
        <input type="text" name="price" value="<?php echo $row['rentprice']?>" class="form-control" id="price">
